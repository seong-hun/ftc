...
from ftc.faults.actuator import LoE, LiP, Float  # [Pyright] [H] "LiP" is not accessed
...
class Env(BaseEnv):
    ...
    def get_forces(self, x):  # [Pyright] [H] "x" is not accessed
    ...
    def logger_callback(self, i, t, y, *args):  # [Pyright] [H] "i" is not accessed  [Pyright] [H] "args" is not accessed
...
def exp1_plot():
    ...
    # [Pyright reportGeneralTypeIssues] [E] No overloads for "__getitem__" match the provided arguments   Argument types: (Literal['t'])
    # [Pyright reportGeneralTypeIssues] [E] No overloads for "__getitem__" match the provided arguments   Argument types: (Literal['W'])
    plt.plot(data["t"], np.diagonal(data["What"], axis1=1, axis2=2), "k-")
    # [Pyright reportGeneralTypeIssues] [E] No overloads for "__getitem__" match the provided arguments   Argument types: (Literal['t'])
    # [Pyright reportGeneralTypeIssues] [E] No overloads for "__getitem__" match the provided arguments   Argument types: (Literal['What'])
