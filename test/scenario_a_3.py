...
class Env(BaseEnv):
    def __init__(self):
        ...
        self.gvec = np.vstack((0, 0, self.plant.g))
    ...
    def set_dot(self, t):
        ...
        return dict(t=t, x=self.plant.observe_dict(), What=What,
                    adaptation_params=Theta_hat.ravel(),
                    rotors=rotors, rotors_cmd=rotors_cmd, W=W, pos_cmd=pos_cmd)
