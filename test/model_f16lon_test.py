...
def exp1_plot():
    ...
    ax = plt.subplot(511)
    plt.plot(data["t"], data["x"][:, 0, 0], label="VT")
    plt.subplot(512, sharex=ax)
    plt.plot(data["t"], data["x"][:, 1, 0], label="gamma")
    plt.subplot(513, sharex=ax)
    plt.plot(data["t"], data["x"][:, 2, 0], label="h")
    plt.subplot(514, sharex=ax)
    plt.plot(data["t"], data["x"][:, 3, 0], label="alp")
    plt.subplot(515, sharex=ax)
    plt.plot(data["t"], data["x"][:, 4, 0], label="q")
    plt.legend()
